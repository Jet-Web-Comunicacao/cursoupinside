...
<div id="local">
   <div class="caminho">Onde Estou: UpImóveis &raquo; Painel de Controle &raquo; Home</div><!--caminho-->
...
$sql_aguardando = 'UPDATE up_imoveis SET imovelStatus = :imovelStatus, imovelConfirma = :imovelConfirma
...
try{
   ...
   <h2>Bem vindo ao painel de anúncios da UpImóveis aqui você pode criar e gerenciar seus anúncios!</h2>
   ...
   <p>Qualquer duvida fique a vontade para entrar em contato pelo e:mail email@upimoveis.com.br ou pelo FONE: 0800 0808-0808</p>
 ...
 $sql_pegaAtivos = 'SELECT * FROM up_imoveis WHERE clienteId = :clienteId 
...
<form target="pagseguro" method="post" action="https://pagseguro.uol.com.br/checkout/checkout.jhtml">
  <input type="hidden" name="email_cobranca" value="loja@upinside.com.br" />
  ...
  <tr style="background:#f4f4f4;">
   ...
   <strong>Para ativar seu imóvel efetue o depósito de R$9:90 na seguinte conta:</strong><br />
    ...
    <strong>Cliente:</strong> Robson V. Leite<br />
